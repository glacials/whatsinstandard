...
<template>
  <div class="accordion" :id="`accordion-${set.internalId}`">
    <div
      class="p-3 list-group-item list-group-item-action text-dark d-flex justify-content-between align-items-start set-border"
      :class="{
    ...
    <div
      ...
      :data-bs-parent="`#accordion-${set.internalId}`"
    >
