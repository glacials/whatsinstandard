...
<html lang="en">
<head>
    <title>Code coverage report for createTippy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> createTippy.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">71.09% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>209/294</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L903'></a><a href='#L903'>903</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Popper from 'popper.js'
...
&nbsp;
  ...
  let transitionEndListener = <span class="fstat-no" title="function not covered" >()</span> =&gt; {}
  let listeners = []
  let referenceJustProgrammaticallyFocused = false
  let debouncedOnMouseMove =
    props.interactiveDebounce &gt; 0
      ? <span class="branch-0 cbranch-no" title="branch not covered" >debounce(onMouseMove, props.interactiveDebounce)</span>
      : onMouseMove
&nbsp;
  /* ======================= 🔑 Public members 🔑 ======================= */
  const id = idCounter++
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (props.showOnInit) {
    /**
     ...
     * properly
     */
<span class="cstat-no" title="statement not covered" >    setTimeout(prepareShow, 20)</span>
  }
&nbsp;
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >followCursorListener(</span>event) {
    const { clientX, clientY } = (<span class="cstat-no" title="statement not covered" >lastMouseMoveEvent = event)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!tip.popperInstance) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    tip.popperInstance.reference = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    tip.popperInstance.scheduleUpdate()</span>
  }
&nbsp;
  /**
   * Creates the tippy instance for a delegate when it's been triggered
   */
  function <span class="fstat-no" title="function not covered" >createDelegateChildTippy(</span>event) {
    const targetEl = <span class="cstat-no" title="statement not covered" >closest(event.target, tip.props.target)</span>
<span class="cstat-no" title="statement not covered" >    if (targetEl &amp;&amp; !targetEl._tippy) {</span>
      const content = <span class="cstat-no" title="statement not covered" >tip.props.content</span>
<span class="cstat-no" title="statement not covered" >      if (content) {</span>
<span class="cstat-no" title="statement not covered" >        createTippy(targetEl, {</span>
          ...tip.props,
          content,
          target: '',
          showOnInit: true
        })
<span class="cstat-no" title="statement not covered" >        prepareShow(event)</span>
      }
    }
  }
&nbsp;
  ...
  function prepareShow(event) {
    clearDelayTimeouts()
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.state.isVisible) {
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    // Is a delegate, create an instance for the child target
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.target) {
<span class="cstat-no" title="statement not covered" >      return createDelegateChildTippy(event)</span>
    }
&nbsp;
...
&nbsp;
     ...
     * upon mount
     */
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hasFollowCursorBehavior()) {
<span class="cstat-no" title="statement not covered" >      if (popperChildren.arrow) {</span>
<span class="cstat-no" title="statement not covered" >        popperChildren.arrow.style.margin = '0'</span>
      }
<span class="cstat-no" title="statement not covered" >      document.addEventListener('mousemove', followCursorListener)</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (delay) {
      hideTimeoutId = setTimeout(() =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (tip.state.isVisible) {
          hide()
        }
      }, delay)
    } else {
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >cleanupOldMouseMoveListeners(</span>) {
<span class="cstat-no" title="statement not covered" >    document.body.removeEventListener('mouseleave', prepareHide)</span>
<span class="cstat-no" title="statement not covered" >    document.removeEventListener('mousemove', debouncedOnMouseMove)</span>
  }
&nbsp;
  /**
  ...
  function onTrigger(event) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!tip.state.isEnabled) {
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    const shouldStopEvent =
      supportsTouch &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >      isUsingTouch </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      ['mouseenter', 'mouseover', 'focus'].indexOf(event.type) &gt; -1</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (shouldStopEvent &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >tip.props.touchHold)</span> {
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >onMouseMove(</span>event) {
    const referenceTheCursorIsOver = <span class="cstat-no" title="statement not covered" >closestCallback(</span>
      event.target,
<span class="fstat-no" title="function not covered" >      el</span> =&gt; <span class="cstat-no" title="statement not covered" >el._tippy</span>
    )
&nbsp;
    const isCursorOverPopper =
<span class="cstat-no" title="statement not covered" >      closest(event.target, Selectors.POPPER) === tip.popper</span>
    const isCursorOverReference = <span class="cstat-no" title="statement not covered" >referenceTheCursorIsOver === tip.reference</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isCursorOverPopper || isCursorOverReference) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      cleanupOldMouseMoveListeners()</span>
<span class="cstat-no" title="statement not covered" >      prepareHide()</span>
    }
  }
&nbsp;
  /**
  ...
  function onMouseLeave(event) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      ...
      supportsTouch &amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      isUsingTouch </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >      tip.props.touchHold</span>
    ) {
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.interactive) {
<span class="cstat-no" title="statement not covered" >      document.body.addEventListener('mouseleave', prepareHide)</span>
<span class="cstat-no" title="statement not covered" >      document.addEventListener('mousemove', debouncedOnMouseMove)</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    prepareHide()
...
<span class="cstat-no" title="statement not covered" >      if (closest(event.relatedTarget, Selectors.POPPER)) {</span>
<span class="cstat-no" title="statement not covered" >        return</span>
      }
    }
&nbsp;
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >onDelegateShow(</span>event) {
<span class="cstat-no" title="statement not covered" >    if (closest(event.target, tip.props.target)) {</span>
<span class="cstat-no" title="statement not covered" >      prepareShow(event)</span>
    }
  }
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >onDelegateHide(</span>event) {
<span class="cstat-no" title="statement not covered" >    if (closest(event.target, tip.props.target)) {</span>
<span class="cstat-no" title="statement not covered" >      prepareHide()</span>
    }
  }
...
&nbsp;
    const arrowSelector =
      Selectors[tip.props.arrowType === 'round' ? <span class="branch-0 cbranch-no" title="branch not covered" >'ROUND_ARROW' </span>: 'ARROW']
    const arrow = tooltip.querySelector(arrowSelector)
&nbsp;
    const config = {
      placement: tip.props.placement,
      ...(popperOptions || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
      modifiers: {
        ...(popperOptions ? popperOptions.modifiers : <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>,
        arrow: {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (arrow &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >tip.props.arrowTransform)</span> {
<span class="cstat-no" title="statement not covered" >          computeArrowTransform(arrow, tip.props.arrowTransform)</span>
        }
      }
    }
&nbsp;
     ...
     * due to async update.
     */
    const observer = new MutationObserver(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      tip.popperInstance.update()</span>
    })
    observer.observe(tip.popper, { childList: true, subtree: true })
    <span class="missing-if-branch" title="if path not taken" >I</span>if (popperMutationObserver) {
<span class="cstat-no" title="statement not covered" >      popperMutationObserver.disconnect()</span>
    }
    popperMutationObserver = observer
&nbsp;
    // fixes https://github.com/atomiks/tippyjs/issues/193
    tip.popper.addEventListener('mouseenter', <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
<span class="cstat-no" title="statement not covered" >      if (tip.state.isVisible &amp;&amp; lastTriggerEvent.type === 'mouseenter') {</span>
<span class="cstat-no" title="statement not covered" >        prepareShow(event)</span>
      }
    })
    tip.popper.addEventListener('mouseleave', <span class="fstat-no" title="function not covered" >ev</span>ent =&gt; {
<span class="cstat-no" title="statement not covered" >      if (</span>
...
&nbsp;
  ...
  function mount(onceUpdated) {
    if (!tip.popperInstance) {
      tip.popperInstance = createPopperInstance()
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!tip.props.livePlacement) {
<span class="cstat-no" title="statement not covered" >        tip.popperInstance.disableEventListeners()</span>
      }
    } else {
...
&nbsp;
    ...
    if (hasFollowCursorBehavior()) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.popperChildren.arrow) {
<span class="cstat-no" title="statement not covered" >        tip.popperChildren.arrow.style.margin = ''</span>
      }
    }
&nbsp;
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >makeSticky(</span>) {
    const updatePosition = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      applyTransitionDuration([tip.popper], tip.props.updateDuration)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (tip.popperInstance) {</span>
<span class="cstat-no" title="statement not covered" >        tip.popperInstance.scheduleUpdate()</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (tip.state.isVisible) {</span>
...
<span class="cstat-no" title="statement not covered" >          defer(updatePosition)</span>
        })
      } else {
<span class="cstat-no" title="statement not covered" >        applyTransitionDuration([tip.popper], 0)</span>
      }
    }
&nbsp;
...
&nbsp;
  ...
  function onTransitionedOut(duration, callback) {
    onTransitionEnd(duration, () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!tip.state.isVisible &amp;&amp; tip.props.appendTo.contains(tip.popper)) {
        callback()
      }
    })
  }
...
&nbsp;
    const { tooltip } = tip.popperChildren
&nbsp;
    const listener = <span class="fstat-no" title="function not covered" >e </span>=&gt; {
<span class="cstat-no" title="statement not covered" >      if (e.target === tooltip) {</span>
<span class="cstat-no" title="statement not covered" >        toggleTransitionEndListener(tooltip, 'remove', listener)</span>
  ...
  function addTriggersToReference() {
    listeners = tip.props.trigger
      ...
      .reduce((acc, eventType) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (eventType === 'manual') {
        ...
        if (!props.target) {
          ...
          switch (eventType) {
            case 'mouseenter':
              ...
              break
            case 'focus':
              on(isIE ? <span class="branch-0 cbranch-no" title="branch not covered" >'focusout' </span>: 'blur', onBlur, acc)
              break
          }
        } else {
          switch (eventType) {
            ...
            case 'focus':
              ...
              break
<span class="branch-2 cbranch-no" title="branch not covered" >            case 'click':</span>
<span class="cstat-no" title="statement not covered" >              on(eventType, onDelegateShow, acc)</span>
...
&nbsp;
  ...
  function set(options) {
    ...
    tip.props = nextProps
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ('trigger' in options) {
<span class="cstat-no" title="statement not covered" >      removeTriggersFromReference()</span>
<span class="cstat-no" title="statement not covered" >      addTriggersToReference()</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ('interactiveDebounce' in options) {
<span class="cstat-no" title="statement not covered" >      cleanupOldMouseMoveListeners()</span>
<span class="cstat-no" title="statement not covered" >      debouncedOnMouseMove = debounce(onMouseMove, options.interactiveDebounce)</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return destroy()</span>
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (referenceJustProgrammaticallyFocused) {
<span class="cstat-no" title="statement not covered" >      referenceJustProgrammaticallyFocused = false</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
...
&nbsp;
      ...
      if (hasFollowCursorBehavior()) {
        tip.popperInstance.disableEventListeners()
        const delay = getValue(tip.props.delay, 0, Defaults.delay)
        <span class="missing-if-branch" title="if path not taken" >I</span>if (lastTriggerEvent.type) {
<span class="cstat-no" title="statement not covered" >          followCursorListener(</span>
...
&nbsp;
      applyTransitionDuration(
        [
          ...
          tip.popperChildren.backdrop ? tip.popperChildren.content : <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
        ],
        duration
      )
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.sticky) {
<span class="cstat-no" title="statement not covered" >        makeSticky()</span>
      }
&nbsp;
      setVisibilityState(
...
&nbsp;
      onTransitionedIn(duration, () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.updateDuration === 0) {
<span class="cstat-no" title="statement not covered" >          tip.popperChildren.tooltip.classList.add('tippy-notransition')</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.interactive &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >lastTriggerEvent.type === 'focus')</span> {
<span class="cstat-no" title="statement not covered" >          focus(tip.popper)</span>
        }
&nbsp;
...
&nbsp;
  ...
  function hide(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.state.isDestroyed || !tip.state.isEnabled) {
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.updateDuration === 0) {
<span class="cstat-no" title="statement not covered" >      tip.popperChildren.tooltip.classList.remove('tippy-notransition')</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tip.props.interactive) {
<span class="cstat-no" title="statement not covered" >      tip.reference.classList.remove('tippy-active')</span>
    }
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >      !referenceJustProgrammaticallyFocused </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      lastTriggerEvent.type === 'focus'</span>
    ) {
<span class="cstat-no" title="statement not covered" >      referenceJustProgrammaticallyFocused = true</span>
<span class="cstat-no" title="statement not covered" >      focus(tip.reference)</span>
    }
&nbsp;
    onTransitionedOut(duration, () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!isPreparingToShow) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Sep 05 2018 18:31:10 GMT+1000 (AEST)
</div>
</div>
