  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>277/277</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">95.83% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>184/192</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">100% </span>
...
<a name='L748'></a><a href='#L748'>748</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5289x</span>
<span class="cline-any cline-yes">5281x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-yes">2x</span>
...
export const injectCSS = css =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (isBrowserSupported) {
...
export const hideAllPoppers = excludeTippy =&gt; {
  toArray(document.querySelectorAll(Selectors.POPPER)).forEach(popper =&gt; {
    ...
    if (
      ...
      (!excludeTippy || <span class="branch-3 cbranch-no" title="branch not covered" >popper !== excludeTippy.popper)</span>
    ) {
      tip.hide()
    }
  })
...
export const matches = (() =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (isBrowser) {
    ...
    return (
      e.matches ||
<span class="branch-1 cbranch-no" title="branch not covered" >      e.matchesSelector </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >      e.webkitMatchesSelector </span>||
<span class="branch-3 cbranch-no" title="branch not covered" >      e.mozMatchesSelector </span>||
<span class="branch-4 cbranch-no" title="branch not covered" >      e.msMatchesSelector</span>
    )
  }
})()
&nbsp;
